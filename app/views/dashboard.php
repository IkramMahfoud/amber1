                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">PRICE <span class="Decore">[</span> <span class="BY"><a
                                        href="<?= URLROOT ?>itemController/orderProduct/item_price/ASC">ASC</a></span> <span
                                    class="Decore">|</span> <span class="BY"><a
                                        href="<?= URLROOT ?>itemController/orderProduct/item_price/DESC">DESC</a></span> <span
                                    class="Decore">]</span></th>
                            <th scope="col">CATEGORY</th>
                            <th scope="col">DATE <span class="Decore">[</span> <span class="BY"><a
                                        href="<?= URLROOT ?>itemController/orderProduct/item_date/ASC">ASC</a></span> <span
                                    class="Decore">|</span> <span class="BY"><a
                                        href="<?= URLROOT ?>itemController/orderProduct/item_date/DESC">DESC</a></span> <span
                                    class="Decore">]</span></th>
